...
class ActionsActivity : AppCompatActivity() {
    companion object { const val OWNER = "byadiganteng-blip"; const val REPO = "youtube-auto-pipeline" }
                        ...
                        try {
                            ...
                            if (arr != null) for (i in 0 until arr.length()) {
                                ...
                                runs.add(WorkflowRun(r.getLong("id"), r.optString("name"),
                                    ...
                                    r.optString("html_url"), r.optInt("run_number"), r.optString("created_at")))
                            }
