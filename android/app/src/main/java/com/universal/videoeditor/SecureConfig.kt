 ...
 * Pakai nullable (bukan lateinit) — aman dipanggil kapan saja.
 *
...
object SecureConfig {
    ...
    /**
     * Init — panggil dari YadApp.onCreate() atau Application.
     * Kalau belum dipanggil, method lain akan return default value (tidak crash).
     */
